...
<article class="pb-32">
	...
	{#if showScrollButton}
		<button
			...
			class="fixed right-0 bottom-12 cursor-pointer rounded-l-full bg-fg p-4 text-2xl md:bottom-52"
		>
			<svg
				...
				class="lucide lucide-chevron-up-icon lucide-chevron-up stroke-bg"
